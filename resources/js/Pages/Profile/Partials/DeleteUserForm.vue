...
<template>
    <section class="space-y-6">
        <header>
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Видалення акаунту</h2>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Після видалення вашого облікового запису всі його дані буде остаточно видалено.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <div class="mt-6 flex justify-end">
                    <SecondaryButton @click="closeModal"> Відмінити </SecondaryButton>
